...
import com.example.androidtrivia.databinding.GameFrgmentBinding


        /*val binding = DataBindingUtil.inflate<GameFrgmentBinding>(inflater,R.layout.game_frgment,container,false)
    return binding.root*/
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding = DataBindingUtil.inflate<GameFrgmentBinding>(
            inflater, R.layout.game_frgment, container, false)
